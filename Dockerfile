...
RUN git clone --single-branch -b stable https://github.com/emoncms/emoncms.git /var/www/html
RUN git clone --single-branch -b stable https://github.com/emoncms/dashboard.git /var/www/html/Modules/dashboard
RUN git clone --single-branch -b stable https://github.com/emoncms/graph.git /var/www/html/Modules/graph
RUN git clone --single-branch -b stable https://github.com/emoncms/app.git /var/www/html/Modules/app
